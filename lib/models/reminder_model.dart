...
class ReminderModel {
  ...
  @override
  String toString() {
    return 'ReminderModel(alarmId: $alarmId, alarmDateTime: $alarmDateTime, alarmTitle: $alarmTitle, isRepeating: $isRepeating, gradientColors: $gradientColors, totalId: $totalId)';
  }
